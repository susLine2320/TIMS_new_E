# うさプラ対応自炊TIMSプラグイン(TIMS_new_E.dll)　ver0.16_E1 2020/06/24
取扱説明書のようなもの
...
このファイルはうさプラ対応TIMSプラグイン(TIMS_new_E.dll)　ver0.16_E1の説明書です。
...
ファイルの配置は、標準でTIMS_new_EをScenarios直下に置いてください。

------------------------------------------
## 仕様について
ver0.14・ver0.16を基準としてverEは小田急線向けATSプラグインとの併用を前提として端子台を一部変更・機能削減しています。
...
参照先はScenarios\TIMS_new_E\TIMS_new_E.dllとなります。
